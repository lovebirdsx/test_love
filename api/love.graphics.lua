...
---@return Image
---@overload fun(fileData:FileData, flags:table):Image
---@overload fun(imageData:ImageData, flags:table):Image
---@overload fun(compressedImageData:CompressedImageData, flags:table):Image
function m.newImage(filename, flags) end
